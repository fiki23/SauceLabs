...
//screenshot
WebUI.takeScreenshot(GlobalVariable.baseUrl + 'TC009_sort Function/sort_button.png')
...
//screenshot
WebUI.takeScreenshot(GlobalVariable.baseUrl + 'TC009_sort Function/dropdown_option.png')
