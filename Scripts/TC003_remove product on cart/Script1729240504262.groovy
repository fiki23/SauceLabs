...
WebUI.click(findTestObject('Object Repository/menu/button_Cart'))
	//screenshot
	WebUI.takeScreenshot(GlobalVariable.baseUrl + 'TC003_remove product on cart/opencart.png')
...
WebUI.click(findTestObject('Object Repository/product/button_removeCart', [('productName') : productName]))
	//screenshot
	WebUI.takeScreenshot(GlobalVariable.baseUrl + 'TC003_remove product on cart/removecart.png')
