...
// screenshot
WebUI.takeScreenshot(GlobalVariable.baseUrl + 'TC002_invalid Login/openBrowser.png')

//Enter username and password
WebUI.setText(findTestObject('Object Repository/Login/input_Username'), username)
WebUI.takeScreenshot(GlobalVariable.baseUrl + 'TC002_invalid Login/usernameEntered.png')

WebUI.setText(findTestObject('Object Repository/Login/input_Password'), password)
WebUI.takeScreenshot(GlobalVariable.baseUrl + 'TC002_invalid Login/passwordEntered.png')

//click login button
WebUI.click(findTestObject('Object Repository/Login/button_Login'))
// screenshot
WebUI.takeScreenshot(GlobalVariable.baseUrl + 'TC002_invalid Login/loginClicked.png')
...
if (isErrorPresent) {
    // screenshot
    WebUI.takeScreenshot(GlobalVariable.baseUrl + 'TC002_invalid Login/errorMessagePresent.png')
    ...
    if (!doesMessageMatch) {
        ...
        // screenshot
        WebUI.takeScreenshot(GlobalVariable.baseUrl + 'TC002_invalid Login/matchingErrorMessage.png')
